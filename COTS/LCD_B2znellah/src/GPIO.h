...
typedef enum
{
	...
	GPIO_PORTA =0x40020000,
	GPIO_PORTB =0x40020400,
	GPIO_PORTC =0x40020800,
	Port_count

}GPIO_AVAILABLE_PORTS;
...
GPIO_enuError_Status GPIO_enuHEXPORT(void* Cpy_enuPort,u16 CpyWriteValue);
